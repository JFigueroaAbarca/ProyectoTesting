...
public class ServiPag {
    ...
    @FindBy('/html/body/modal-container/div/div/login-modal-login/div/div[2]/form/section/div[2]/input')
    WebElement inputPass;

    @FindBy('/html/body/modal-container/div/div/login-modal-login/div/div[2]/form/section/button')
